            ...
            <div className="max-w-[1200px] mx-auto w-full relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-start">
                    ...
                    <div className="relative w-full h-full flex flex-col justify-start">
                        <LiquidGlass />
                        <div className="rounded-2xl p-8 sm:p-12 relative overflow-hidden z-10">
                            ...
                            <div className="space-y-10">
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="group w-12 h-12 rounded-full flex items-center relative justify-center shrink-0">
                                        <LiquidGlass />
                                        <svg className="w-5 h-5 group-hover:text-(--color-secondary) duration-300 text-white/50 relative z-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-4">
                                        {/* Twitter */}
                                        <a href="#" aria-label="Twitter" className="w-10 h-10 rounded-full flex items-center justify-center transition-all text-white/50 group hover:text-(--color-secondary) duration-300 relative">
                                            <LiquidGlass />
                                        ...
                                        {/* LinkedIn */}
                                        <a href="#" aria-label="LinkedIn" className="w-10 h-10 rounded-full flex items-center justify-center transition-all text-white/50 group hover:text-(--color-secondary) duration-300 relative">
                                            <LiquidGlass />
                                            <svg className="w-4 h-4 relative z-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                        ...
                                        {/* GitHub */}
                                        <a href="#" aria-label="GitHub" className="w-10 h-10 rounded-full flex items-center justify-center transition-all text-white/50 group hover:text-(--color-secondary) duration-300 relative">
                                            <LiquidGlass />
                                            <svg className="w-4 h-4 relative z-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <div className="relative">
                        ...
                        {!isSubmitted ? (
                            ...
                            <div className="relative z-10 max-w-2xl py-16 sm:py-24 text-center flex flex-col items-center animate-fadeIn">
                                <div className="w-16 h-16 rounded-full border border-white/10 bg-white flex items-center justify-center mb-8 shadow-[0_0_30px_rgba(255,255,255,0.03)]">
