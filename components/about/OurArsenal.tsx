        ...
        <section className='py-20 md:py-28 lg:py-32 px-5 relative overflow-x-clip border-t border-white/5'>
            <div className="max-w-[800px] mx-auto w-full">
                <SmoothAnimtionWrapper className="flex flex-col gap-12 sm:gap-16">
                    ...
                    <div className="relative w-full flex flex-col border-t border-white/10">
                        {techStackData.map((tech, index) => (
                            <SmoothAnimtionWrapper key={index} className="group relative flex flex-col sm:flex-row sm:items-center justify-between py-6 sm:py-8 border-b border-white/10 transition-colors duration-500 hover:border-white/30">
