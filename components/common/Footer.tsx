                ...
                <div className="flex flex-col lg:flex-row justify-between w-full gap-12 lg:gap-8">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col gap-6">
                        ...
                        <div className="flex items-center gap-3 mt-2">
                            <Link href="#" className="w-10 h-10 rounded-full border border-[#202020] bg-white/5 flex justify-center items-center text-[#B8B8B8] hover:bg-white/10 hover:text-white transition-all backdrop-blur-md">
                                {/* Github */}
