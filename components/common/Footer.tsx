                ...
                <div className="flex flex-col lg:flex-row justify-between w-full gap-12 lg:gap-8">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col gap-6">
                        ...
                        <div className="flex items-center gap-3 mt-2">
                            <Link href="#" aria-label="Github" className="w-10 h-10 rounded-full border border-[#202020] bg-white/5 flex justify-center items-center text-[#B8B8B8] hover:text-(--color-secondary)! hover:bg-white/10 hover:text-white transition-all backdrop-blur-md">
                                {/* Github */}
                            ...
                            <Link href="#" aria-label="Twitter" className="w-10 h-10 rounded-full border border-[#202020] bg-white/5 flex justify-center items-center text-[#B8B8B8] hover:text-(--color-secondary)! hover:bg-white/10 hover:text-white transition-all backdrop-blur-md">
                                {/* Twitter/X */}
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                            </Link>
                            <Link href="#" aria-label="LinkedIn" className="w-10 h-10 rounded-full border border-[#202020] bg-white/5 flex justify-center items-center text-[#B8B8B8] hover:text-(--color-secondary)! hover:bg-white/10 hover:text-white transition-all backdrop-blur-md">
                                {/* Linkedin */}
                            ...
                            <Link href="#" aria-label="Discord" className="w-10 h-10 rounded-full border border-[#202020] bg-white/5 flex justify-center items-center text-[#B8B8B8] hover:text-(--color-secondary)! hover:bg-white/10 hover:text-white transition-all backdrop-blur-md">
                                {/* Discord */}
