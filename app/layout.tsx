...
})(window,document,'script','dataLayer','GTM-MPJ8QZ4K');`}} />
      </head>
      <body
        className={`${poppins.className} antialiased bg-black`}
      >
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MPJ8QZ4K" height="0" width="0" style={{ display: "none", visibility: "hidden" }}></iframe></noscript>
        <Navbar />
        <main>
          {children}
        </main>
